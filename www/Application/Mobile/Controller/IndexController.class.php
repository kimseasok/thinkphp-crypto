...
class IndexController extends MobileController
{
	...
	public function tgcode(){
		...
		$uinfo = M("user")->where(array('id'=>$uid))->field("id,username,invit,invit_1money,invit_2money,invit_3money")->find();
		$invit = $uinfo['invit'];
        ...
        $this->assign('invit1',$uinfo['invit_1money']);
        $this->assign('invit2',$uinfo['invit_2money']);
        $this->assign('invit3',$uinfo['invit_3money']);
		$this->assign('url',$url);
